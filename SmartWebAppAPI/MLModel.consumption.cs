...
namespace SmartWebAppAPI
{
    public partial class MLModel
    {
        ...
        public class ModelInput
        {
            [LoadColumn(0)]
            [ColumnName(@"Co�rafya")]
            public float Co_rafya { get; set; }

            [LoadColumn(1)]
            [ColumnName(@"Yerle�im_Plan�")]
            public float Yerle_im_Plan_ { get; set; }

            [LoadColumn(2)]
            [ColumnName(@"Bina_Mimari")]
            public float Bina_Mimari { get; set; }

            [LoadColumn(3)]
            [ColumnName(@"Veri_Density")]
            public float Veri_Density { get; set; }
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Standart");
            if (labelColumn == null)
            {
                throw new Exception("Standart column not found. Make sure the name searched for matches the name in the schema.");
            }
